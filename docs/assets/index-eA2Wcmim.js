...
`},gt="\\f",Be={type:"literal",value:"\\f",description:'"\\\\f"'},wt=function(){return"\f"},ot="\\r",Kt={type:"literal",value:"\\r",description:'"\\\\r"'},ti=function(){return"\r"},Xt="\\U",_i={type:"literal",value:"\\U",description:'"\\\\U"'},At=function(u){return Gh(u.join(""))},jt="\\u",rn={type:"literal",value:"\\u",description:'"\\\\u"'},d=0,ve=0,Hn=0,En={line:1,column:1,seenCR:!1},fr=0,ya=[],ie=0,re={},dr;if("startRule"in s){if(!(s.startRule in a))throw new Error(`Can't start parsing from rule "`+s.startRule+'".');l=a[s.startRule]}function Ht(){return Sa(ve).line}function Vt(){return Sa(ve).column}function Sa(u){function _(y,C,U){var V,Q;for(V=C;V<U;V++)Q=n.charAt(V),Q===`
`?(y.seenCR||y.line++,y.column=1,y.seenCR=!1):Q==="\r"||Q==="\u2028"||Q==="\u2029"?(y.line++,y.column=1,y.seenCR=!0):(y.column++,y.seenCR=!1)}return Hn!==u&&(Hn>u&&(Hn=0,En={line:1,column:1,seenCR:!1}),_(En,Hn,u),Hn=u),En}function he(u){d<fr||(d>fr&&(fr=d,ya=[]),ya.push(u))}function Th(u,_,y){function C(Ee){var Xe=1;for(Ee.sort(function(Mt,ht){return Mt.description<ht.description?-1:Mt.description>ht.description?1:0});Xe<Ee.length;)Ee[Xe-1]===Ee[Xe]?Ee.splice(Xe,1):Xe++}function U(Ee,Xe){function Mt(Gi){function ni(ln){return ln.charCodeAt(0).toString(16).toUpperCase()}return Gi.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\x08/g,"\\b").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\f/g,"\\f").replace(/\r/g,"\\r").replace(/[\x00-\x07\x0B\x0E\x0F]/g,function(ln){return"\\x0"+ni(ln)}).replace(/[\x10-\x1F\x80-\xFF]/g,function(ln){return"\\x"+ni(ln)}).replace(/[\u0180-\u0FFF]/g,function(ln){return"\\u0"+ni(ln)}).replace(/[\u1080-\uFFFF]/g,function(ln){return"\\u"+ni(ln)})}var ht=new Array(Ee.length),Lt,It,on;for(on=0;on<Ee.length;on++)ht[on]=Ee[on].description;return Lt=Ee.length>1?ht.slice(0,-1).join(", ")+" or "+ht[Ee.length-1]:ht[0],It=Xe?'"'+Mt(Xe)+'"':"end of input","Expected "+Lt+" but "+It+" found."}var V=Sa(y),Q=y<n.length?n.charAt(y):null;return _!==null&&C(_),new e(U(_,Q),_,Q,y,V.line,V.column)}function Ul(){var u,_,y,C=d*49+0,U=re[C];if(U)return d=U.nextPos,U.result;for(u=d,_=[],y=Nl();y!==i;)_.push(y),y=Nl();return _!==i&&(ve=u,_=c()),u=_,re[C]={nextPos:d,result:u},u}function Nl(){var u,_,y,C,U,V,Q,Ee=d*49+1,Xe=re[Ee];if(Xe)return d=Xe.nextPos,Xe.result;for(u=d,_=[],y=Re();y!==i;)_.push(y),y=Re();if(_!==i)if(y=bh(),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();if(C!==i){for(U=[],V=pr();V!==i;)U.push(V),V=pr();if(U!==i){if(V=[],Q=pn(),Q!==i)for(;Q!==i;)V.push(Q),Q=pn();else V=o;V===i&&(V=gr()),V!==i?(_=[_,y,C,U,V],u=_):(d=u,u=o)}else d=u,u=o}else d=u,u=o}else d=u,u=o;else d=u,u=o;if(u===i){if(u=d,_=[],y=Re(),y!==i)for(;y!==i;)_.push(y),y=Re();else _=o;if(_!==i){if(y=[],C=pn(),C!==i)for(;C!==i;)y.push(C),C=pn();else y=o;y===i&&(y=gr()),y!==i?(_=[_,y],u=_):(d=u,u=o)}else d=u,u=o;u===i&&(u=pn())}return re[Ee]={nextPos:d,result:u},u}function bh(){var u,_=d*49+2,y=re[_];return y?(d=y.nextPos,y.result):(u=pr(),u===i&&(u=Ah(),u===i&&(u=wh(),u===i&&(u=Rh()))),re[_]={nextPos:d,result:u},u)}function pr(){var u,_,y,C,U,V,Q=d*49+3,Ee=re[Q];if(Ee)return d=Ee.nextPos,Ee.result;if(u=d,n.charCodeAt(d)===35?(_=h,d++):(_=i,ie===0&&he(f)),_!==i){for(y=[],C=d,U=d,ie++,V=pn(),V===i&&(V=gr()),ie--,V===i?U=p:(d=U,U=o),U!==i?(n.length>d?(V=n.charAt(d),d++):(V=i,ie===0&&he(g)),V!==i?(U=[U,V],C=U):(d=C,C=o)):(d=C,C=o);C!==i;)y.push(C),C=d,U=d,ie++,V=pn(),V===i&&(V=gr()),ie--,V===i?U=p:(d=U,U=o),U!==i?(n.length>d?(V=n.charAt(d),d++):(V=i,ie===0&&he(g)),V!==i?(U=[U,V],C=U):(d=C,C=o)):(d=C,C=o);y!==i?(_=[_,y],u=_):(d=u,u=o)}else d=u,u=o;return re[Q]={nextPos:d,result:u},u}function Ah(){var u,_,y,C,U,V,Q=d*49+4,Ee=re[Q];if(Ee)return d=Ee.nextPos,Ee.result;if(u=d,n.charCodeAt(d)===91?(_=v,d++):(_=i,ie===0&&he(M)),_!==i){for(y=[],C=Re();C!==i;)y.push(C),C=Re();if(y!==i)if(C=Fl(),C!==i){for(U=[],V=Re();V!==i;)U.push(V),V=Re();U!==i?(n.charCodeAt(d)===93?(V=x,d++):(V=i,ie===0&&he(m)),V!==i?(ve=u,_=R(C),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;return re[Q]={nextPos:d,result:u},u}function wh(){var u,_,y,C,U,V,Q,Ee,Xe=d*49+5,Mt=re[Xe];if(Mt)return d=Mt.nextPos,Mt.result;if(u=d,n.charCodeAt(d)===91?(_=v,d++):(_=i,ie===0&&he(M)),_!==i)if(n.charCodeAt(d)===91?(y=v,d++):(y=i,ie===0&&he(M)),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();if(C!==i)if(U=Fl(),U!==i){for(V=[],Q=Re();Q!==i;)V.push(Q),Q=Re();V!==i?(n.charCodeAt(d)===93?(Q=x,d++):(Q=i,ie===0&&he(m)),Q!==i?(n.charCodeAt(d)===93?(Ee=x,d++):(Ee=i,ie===0&&he(m)),Ee!==i?(ve=u,_=b(U),u=_):(d=u,u=o)):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o;return re[Xe]={nextPos:d,result:u},u}function Fl(){var u,_,y,C=d*49+6,U=re[C];if(U)return d=U.nextPos,U.result;if(u=d,_=[],y=Bl(),y!==i)for(;y!==i;)_.push(y),y=Bl();else _=o;return _!==i?(y=Ol(),y!==i?(ve=u,_=E(_,y),u=_):(d=u,u=o)):(d=u,u=o),u===i&&(u=d,_=Ol(),_!==i&&(ve=u,_=I(_)),u=_),re[C]={nextPos:d,result:u},u}function Ol(){var u,_,y,C,U,V=d*49+7,Q=re[V];if(Q)return d=Q.nextPos,Q.result;for(u=d,_=[],y=Re();y!==i;)_.push(y),y=Re();if(_!==i)if(y=Ps(),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();C!==i?(ve=u,_=D(y),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o;if(u===i){for(u=d,_=[],y=Re();y!==i;)_.push(y),y=Re();if(_!==i)if(y=Ea(),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();C!==i?(ve=u,_=D(y),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o}return re[V]={nextPos:d,result:u},u}function Bl(){var u,_,y,C,U,V,Q,Ee=d*49+8,Xe=re[Ee];if(Xe)return d=Xe.nextPos,Xe.result;for(u=d,_=[],y=Re();y!==i;)_.push(y),y=Re();if(_!==i)if(y=Ps(),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();if(C!==i)if(n.charCodeAt(d)===46?(U=N,d++):(U=i,ie===0&&he(k)),U!==i){for(V=[],Q=Re();Q!==i;)V.push(Q),Q=Re();V!==i?(ve=u,_=D(y),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o;if(u===i){for(u=d,_=[],y=Re();y!==i;)_.push(y),y=Re();if(_!==i)if(y=Ea(),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();if(C!==i)if(n.charCodeAt(d)===46?(U=N,d++):(U=i,ie===0&&he(k)),U!==i){for(V=[],Q=Re();Q!==i;)V.push(Q),Q=Re();V!==i?(ve=u,_=D(y),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o}return re[Ee]={nextPos:d,result:u},u}function Rh(){var u,_,y,C,U,V,Q=d*49+9,Ee=re[Q];if(Ee)return d=Ee.nextPos,Ee.result;if(u=d,_=Ps(),_!==i){for(y=[],C=Re();C!==i;)y.push(C),C=Re();if(y!==i)if(n.charCodeAt(d)===61?(C=A,d++):(C=i,ie===0&&he(w)),C!==i){for(U=[],V=Re();V!==i;)U.push(V),V=Re();U!==i?(V=Vi(),V!==i?(ve=u,_=L(_,V),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;if(u===i)if(u=d,_=Ea(),_!==i){for(y=[],C=Re();C!==i;)y.push(C),C=Re();if(y!==i)if(n.charCodeAt(d)===61?(C=A,d++):(C=i,ie===0&&he(w)),C!==i){for(U=[],V=Re();V!==i;)U.push(V),V=Re();U!==i?(V=Vi(),V!==i?(ve=u,_=L(_,V),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;return re[Q]={nextPos:d,result:u},u}function Ps(){var u,_,y,C=d*49+10,U=re[C];if(U)return d=U.nextPos,U.result;if(u=d,_=[],y=Zl(),y!==i)for(;y!==i;)_.push(y),y=Zl();else _=o;return _!==i&&(ve=u,_=Y(_)),u=_,re[C]={nextPos:d,result:u},u}function Ea(){var u,_,y=d*49+11,C=re[y];return C?(d=C.nextPos,C.result):(u=d,_=kl(),_!==i&&(ve=u,_=X(_)),u=_,u===i&&(u=d,_=zl(),_!==i&&(ve=u,_=X(_)),u=_),re[y]={nextPos:d,result:u},u)}function Vi(){var u,_=d*49+12,y=re[_];return y?(d=y.nextPos,y.result):(u=Ch(),u===i&&(u=zh(),u===i&&(u=Dh(),u===i&&(u=Uh(),u===i&&(u=Nh(),u===i&&(u=Fh(),u===i&&(u=Oh())))))),re[_]={nextPos:d,result:u},u)}function Ch(){var u,_=d*49+13,y=re[_];return y?(d=y.nextPos,y.result):(u=Ph(),u===i&&(u=kl(),u===i&&(u=Lh(),u===i&&(u=zl()))),re[_]={nextPos:d,result:u},u)}function Ph(){var u,_,y,C,U,V=d*49+14,Q=re[V];if(Q)return d=Q.nextPos,Q.result;if(u=d,n.substr(d,3)===G?(_=G,d+=3):(_=i,ie===0&&he(ne)),_!==i)if(y=pn(),y===i&&(y=K),y!==i){for(C=[],U=Gl();U!==i;)C.push(U),U=Gl();C!==i?(n.substr(d,3)===G?(U=G,d+=3):(U=i,ie===0&&he(ne)),U!==i?(ve=u,_=oe(C),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;else d=u,u=o;return re[V]={nextPos:d,result:u},u}function kl(){var u,_,y,C,U=d*49+15,V=re[U];if(V)return d=V.nextPos,V.result;if(u=d,n.charCodeAt(d)===34?(_=j,d++):(_=i,ie===0&&he(me)),_!==i){for(y=[],C=Hl();C!==i;)y.push(C),C=Hl();y!==i?(n.charCodeAt(d)===34?(C=j,d++):(C=i,ie===0&&he(me)),C!==i?(ve=u,_=oe(y),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;return re[U]={nextPos:d,result:u},u}function Lh(){var u,_,y,C,U,V=d*49+16,Q=re[V];if(Q)return d=Q.nextPos,Q.result;if(u=d,n.substr(d,3)===_e?(_=_e,d+=3):(_=i,ie===0&&he(Ie)),_!==i)if(y=pn(),y===i&&(y=K),y!==i){for(C=[],U=Wl();U!==i;)C.push(U),U=Wl();C!==i?(n.substr(d,3)===_e?(U=_e,d+=3):(U=i,ie===0&&he(Ie)),U!==i?(ve=u,_=oe(C),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;else d=u,u=o;return re[V]={nextPos:d,result:u},u}function zl(){var u,_,y,C,U=d*49+17,V=re[U];if(V)return d=V.nextPos,V.result;if(u=d,n.charCodeAt(d)===39?(_=qe,d++):(_=i,ie===0&&he(pt)),_!==i){for(y=[],C=Vl();C!==i;)y.push(C),C=Vl();y!==i?(n.charCodeAt(d)===39?(C=qe,d++):(C=i,ie===0&&he(pt)),C!==i?(ve=u,_=oe(y),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;return re[U]={nextPos:d,result:u},u}function Hl(){var u,_,y,C=d*49+18,U=re[C];return U?(d=U.nextPos,U.result):(u=Jl(),u===i&&(u=d,_=d,ie++,n.charCodeAt(d)===34?(y=j,d++):(y=i,ie===0&&he(me)),ie--,y===i?_=p:(d=_,_=o),_!==i?(n.length>d?(y=n.charAt(d),d++):(y=i,ie===0&&he(g)),y!==i?(ve=u,_=ct(y),u=_):(d=u,u=o)):(d=u,u=o)),re[C]={nextPos:d,result:u},u)}function Vl(){var u,_,y,C=d*49+19,U=re[C];return U?(d=U.nextPos,U.result):(u=d,_=d,ie++,n.charCodeAt(d)===39?(y=qe,d++):(y=i,ie===0&&he(pt)),ie--,y===i?_=p:(d=_,_=o),_!==i?(n.length>d?(y=n.charAt(d),d++):(y=i,ie===0&&he(g)),y!==i?(ve=u,_=ct(y),u=_):(d=u,u=o)):(d=u,u=o),re[C]={nextPos:d,result:u},u)}function Gl(){var u,_,y,C=d*49+20,U=re[C];return U?(d=U.nextPos,U.result):(u=Jl(),u===i&&(u=Ih(),u===i&&(u=d,_=d,ie++,n.substr(d,3)===G?(y=G,d+=3):(y=i,ie===0&&he(ne)),ie--,y===i?_=p:(d=_,_=o),_!==i?(n.length>d?(y=n.charAt(d),d++):(y=i,ie===0&&he(g)),y!==i?(ve=u,_=J(y),u=_):(d=u,u=o)):(d=u,u=o))),re[C]={nextPos:d,result:u},u)}function Ih(){var u,_,y,C,U,V=d*49+21,Q=re[V];if(Q)return d=Q.nextPos,Q.result;if(u=d,n.charCodeAt(d)===92?(_=ge,d++):(_=i,ie===0&&he(de)),_!==i)if(y=pn(),y!==i){for(C=[],U=jl();U!==i;)C.push(U),U=jl();C!==i?(ve=u,_=ke(),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o;return re[V]={nextPos:d,result:u},u}function Wl(){var u,_,y,C=d*49+22,U=re[C];return U?(d=U.nextPos,U.result):(u=d,_=d,ie++,n.substr(d,3)===_e?(y=_e,d+=3):(y=i,ie===0&&he(Ie)),ie--,y===i?_=p:(d=_,_=o),_!==i?(n.length>d?(y=n.charAt(d),d++):(y=i,ie===0&&he(g)),y!==i?(ve=u,_=ct(y),u=_):(d=u,u=o)):(d=u,u=o),re[C]={nextPos:d,result:u},u)}function Dh(){var u,_,y,C,U=d*49+23,V=re[U];return V?(d=V.nextPos,V.result):(u=d,_=Xl(),_===i&&(_=Ta()),_!==i?(n.charCodeAt(d)===101?(y=ze,d++):(y=i,ie===0&&he(Ye)),y===i&&(n.charCodeAt(d)===69?(y=Pt,d++):(y=i,ie===0&&he(rt))),y!==i?(C=Ta(),C!==i?(ve=u,_=F(_,C),u=_):(d=u,u=o)):(d=u,u=o)):(d=u,u=o),u===i&&(u=d,_=Xl(),_!==i&&(ve=u,_=Et(_)),u=_),re[U]={nextPos:d,result:u},u)}function Xl(){var u,_,y,C,U,V,Q=d*49+24,Ee=re[Q];return Ee?(d=Ee.nextPos,Ee.result):(u=d,n.charCodeAt(d)===43?(_=Fe,d++):(_=i,ie===0&&he(at)),_===i&&(_=K),_!==i?(y=d,C=Ls(),C!==i?(n.charCodeAt(d)===46?(U=N,d++):(U=i,ie===0&&he(k)),U!==i?(V=Ls(),V!==i?(C=[C,U,V],y=C):(d=y,y=o)):(d=y,y=o)):(d=y,y=o),y!==i?(ve=u,_=Ne(y),u=_):(d=u,u=o)):(d=u,u=o),u===i&&(u=d,n.charCodeAt(d)===45?(_=mt,d++):(_=i,ie===0&&he(Te)),_!==i?(y=d,C=Ls(),C!==i?(n.charCodeAt(d)===46?(U=N,d++):(U=i,ie===0&&he(k)),U!==i?(V=Ls(),V!==i?(C=[C,U,V],y=C):(d=y,y=o)):(d=y,y=o)):(d=y,y=o),y!==i?(ve=u,_=Ze(y),u=_):(d=u,u=o)):(d=u,u=o)),re[Q]={nextPos:d,result:u},u)}function Uh(){var u,_,y=d*49+25,C=re[y];return C?(d=C.nextPos,C.result):(u=d,_=Ta(),_!==i&&(ve=u,_=Dt(_)),u=_,re[y]={nextPos:d,result:u},u)}function Ta(){var u,_,y,C,U,V=d*49+26,Q=re[V];if(Q)return d=Q.nextPos,Q.result;if(u=d,n.charCodeAt(d)===43?(_=Fe,d++):(_=i,ie===0&&he(at)),_===i&&(_=K),_!==i){if(y=[],C=_t(),C!==i)for(;C!==i;)y.push(C),C=_t();else y=o;y!==i?(C=d,ie++,n.charCodeAt(d)===46?(U=N,d++):(U=i,ie===0&&he(k)),ie--,U===i?C=p:(d=C,C=o),C!==i?(ve=u,_=Ne(y),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;if(u===i)if(u=d,n.charCodeAt(d)===45?(_=mt,d++):(_=i,ie===0&&he(Te)),_!==i){if(y=[],C=_t(),C!==i)for(;C!==i;)y.push(C),C=_t();else y=o;y!==i?(C=d,ie++,n.charCodeAt(d)===46?(U=N,d++):(U=i,ie===0&&he(k)),ie--,U===i?C=p:(d=C,C=o),C!==i?(ve=u,_=Ze(y),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;return re[V]={nextPos:d,result:u},u}function Nh(){var u,_,y=d*49+27,C=re[y];return C?(d=C.nextPos,C.result):(u=d,n.substr(d,4)===Rt?(_=Rt,d+=4):(_=i,ie===0&&he(P)),_!==i&&(ve=u,_=S()),u=_,u===i&&(u=d,n.substr(d,5)===W?(_=W,d+=5):(_=i,ie===0&&he(ee)),_!==i&&(ve=u,_=se()),u=_),re[y]={nextPos:d,result:u},u)}function Fh(){var u,_,y,C,U,V=d*49+28,Q=re[V];if(Q)return d=Q.nextPos,Q.result;if(u=d,n.charCodeAt(d)===91?(_=v,d++):(_=i,ie===0&&he(M)),_!==i){for(y=[],C=dn();C!==i;)y.push(C),C=dn();y!==i?(n.charCodeAt(d)===93?(C=x,d++):(C=i,ie===0&&he(m)),C!==i?(ve=u,_=Z(),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;if(u===i&&(u=d,n.charCodeAt(d)===91?(_=v,d++):(_=i,ie===0&&he(M)),_!==i?(y=$l(),y===i&&(y=K),y!==i?(n.charCodeAt(d)===93?(C=x,d++):(C=i,ie===0&&he(m)),C!==i?(ve=u,_=Ue(y),u=_):(d=u,u=o)):(d=u,u=o)):(d=u,u=o),u===i)){if(u=d,n.charCodeAt(d)===91?(_=v,d++):(_=i,ie===0&&he(M)),_!==i){if(y=[],C=mr(),C!==i)for(;C!==i;)y.push(C),C=mr();else y=o;y!==i?(n.charCodeAt(d)===93?(C=x,d++):(C=i,ie===0&&he(m)),C!==i?(ve=u,_=fe(y),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;if(u===i)if(u=d,n.charCodeAt(d)===91?(_=v,d++):(_=i,ie===0&&he(M)),_!==i){if(y=[],C=mr(),C!==i)for(;C!==i;)y.push(C),C=mr();else y=o;y!==i?(C=$l(),C!==i?(n.charCodeAt(d)===93?(U=x,d++):(U=i,ie===0&&he(m)),U!==i?(ve=u,_=Pe(y,C),u=_):(d=u,u=o)):(d=u,u=o)):(d=u,u=o)}else d=u,u=o}return re[V]={nextPos:d,result:u},u}function $l(){var u,_,y,C,U,V=d*49+29,Q=re[V];if(Q)return d=Q.nextPos,Q.result;for(u=d,_=[],y=dn();y!==i;)_.push(y),y=dn();if(_!==i)if(y=Vi(),y!==i){for(C=[],U=dn();U!==i;)C.push(U),U=dn();C!==i?(ve=u,_=Le(y),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o;return re[V]={nextPos:d,result:u},u}function mr(){var u,_,y,C,U,V,Q,Ee=d*49+30,Xe=re[Ee];if(Xe)return d=Xe.nextPos,Xe.result;for(u=d,_=[],y=dn();y!==i;)_.push(y),y=dn();if(_!==i)if(y=Vi(),y!==i){for(C=[],U=dn();U!==i;)C.push(U),U=dn();if(C!==i)if(n.charCodeAt(d)===44?(U=ce,d++):(U=i,ie===0&&he(ye)),U!==i){for(V=[],Q=dn();Q!==i;)V.push(Q),Q=dn();V!==i?(ve=u,_=Le(y),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o;return re[Ee]={nextPos:d,result:u},u}function dn(){var u,_=d*49+31,y=re[_];return y?(d=y.nextPos,y.result):(u=Re(),u===i&&(u=pn(),u===i&&(u=pr())),re[_]={nextPos:d,result:u},u)}function Oh(){var u,_,y,C,U,V,Q=d*49+32,Ee=re[Q];if(Ee)return d=Ee.nextPos,Ee.result;if(u=d,n.charCodeAt(d)===123?(_=Ge,d++):(_=i,ie===0&&he(De)),_!==i){for(y=[],C=Re();C!==i;)y.push(C),C=Re();if(y!==i){for(C=[],U=ql();U!==i;)C.push(U),U=ql();if(C!==i){for(U=[],V=Re();V!==i;)U.push(V),V=Re();U!==i?(n.charCodeAt(d)===125?(V=xe,d++):(V=i,ie===0&&he(je)),V!==i?(ve=u,_=B(C),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o}else d=u,u=o}else d=u,u=o;return re[Q]={nextPos:d,result:u},u}function ql(){var u,_,y,C,U,V,Q,Ee,Xe,Mt,ht,Lt=d*49+33,It=re[Lt];if(It)return d=It.nextPos,It.result;for(u=d,_=[],y=Re();y!==i;)_.push(y),y=Re();if(_!==i)if(y=Ps(),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();if(C!==i)if(n.charCodeAt(d)===61?(U=A,d++):(U=i,ie===0&&he(w)),U!==i){for(V=[],Q=Re();Q!==i;)V.push(Q),Q=Re();if(V!==i)if(Q=Vi(),Q!==i){for(Ee=[],Xe=Re();Xe!==i;)Ee.push(Xe),Xe=Re();if(Ee!==i)if(n.charCodeAt(d)===44?(Xe=ce,d++):(Xe=i,ie===0&&he(ye)),Xe!==i){for(Mt=[],ht=Re();ht!==i;)Mt.push(ht),ht=Re();Mt!==i?(ve=u,_=ue(y,Q),u=_):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o;if(u===i){for(u=d,_=[],y=Re();y!==i;)_.push(y),y=Re();if(_!==i)if(y=Ps(),y!==i){for(C=[],U=Re();U!==i;)C.push(U),U=Re();if(C!==i)if(n.charCodeAt(d)===61?(U=A,d++):(U=i,ie===0&&he(w)),U!==i){for(V=[],Q=Re();Q!==i;)V.push(Q),Q=Re();V!==i?(Q=Vi(),Q!==i?(ve=u,_=ue(y,Q),u=_):(d=u,u=o)):(d=u,u=o)}else d=u,u=o;else d=u,u=o}else d=u,u=o;else d=u,u=o}return re[Lt]={nextPos:d,result:u},u}function Yl(){var u,_,y,C=d*49+34,U=re[C];return U?(d=U.nextPos,U.result):(u=d,n.charCodeAt(d)===46?(_=N,d++):(_=i,ie===0&&he(k)),_!==i?(y=Ls(),y!==i?(ve=u,_=pe(y),u=_):(d=u,u=o)):(d=u,u=o),re[C]={nextPos:d,result:u},u)}function Kl(){var u,_,y,C,U,V,Q,Ee,Xe,Mt,ht,Lt,It=d*49+35,on=re[It];return on?(d=on.nextPos,on.result):(u=d,_=d,y=_t(),y!==i?(C=_t(),C!==i?(U=_t(),U!==i?(V=_t(),V!==i?(n.charCodeAt(d)===45?(Q=mt,d++):(Q=i,ie===0&&he(Te)),Q!==i?(Ee=_t(),Ee!==i?(Xe=_t(),Xe!==i?(n.charCodeAt(d)===45?(Mt=mt,d++):(Mt=i,ie===0&&he(Te)),Mt!==i?(ht=_t(),ht!==i?(Lt=_t(),Lt!==i?(y=[y,C,U,V,Q,Ee,Xe,Mt,ht,Lt],_=y):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o),_!==i&&(ve=u,_=Ae(_)),u=_,re[It]={nextPos:d,result:u},u)}function Bh(){var u,_,y,C,U,V,Q,Ee,Xe,Mt,ht,Lt=d*49+36,It=re[Lt];return It?(d=It.nextPos,It.result):(u=d,_=d,y=_t(),y!==i?(C=_t(),C!==i?(n.charCodeAt(d)===58?(U=ae,d++):(U=i,ie===0&&he(te)),U!==i?(V=_t(),V!==i?(Q=_t(),Q!==i?(n.charCodeAt(d)===58?(Ee=ae,d++):(Ee=i,ie===0&&he(te)),Ee!==i?(Xe=_t(),Xe!==i?(Mt=_t(),Mt!==i?(ht=Yl(),ht===i&&(ht=K),ht!==i?(y=[y,C,U,V,Q,Ee,Xe,Mt,ht],_=y):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o),_!==i&&(ve=u,_=Ce(_)),u=_,re[Lt]={nextPos:d,result:u},u)}function kh(){var u,_,y,C,U,V,Q,Ee,Xe,Mt,ht,Lt,It,on,Gi,ni,ln,ec=d*49+37,Aa=re[ec];return Aa?(d=Aa.nextPos,Aa.result):(u=d,_=d,y=_t(),y!==i?(C=_t(),C!==i?(n.charCodeAt(d)===58?(U=ae,d++):(U=i,ie===0&&he(te)),U!==i?(V=_t(),V!==i?(Q=_t(),Q!==i?(n.charCodeAt(d)===58?(Ee=ae,d++):(Ee=i,ie===0&&he(te)),Ee!==i?(Xe=_t(),Xe!==i?(Mt=_t(),Mt!==i?(ht=Yl(),ht===i&&(ht=K),ht!==i?(n.charCodeAt(d)===45?(Lt=mt,d++):(Lt=i,ie===0&&he(Te)),Lt===i&&(n.charCodeAt(d)===43?(Lt=Fe,d++):(Lt=i,ie===0&&he(at))),Lt!==i?(It=_t(),It!==i?(on=_t(),on!==i?(n.charCodeAt(d)===58?(Gi=ae,d++):(Gi=i,ie===0&&he(te)),Gi!==i?(ni=_t(),ni!==i?(ln=_t(),ln!==i?(y=[y,C,U,V,Q,Ee,Xe,Mt,ht,Lt,It,on,Gi,ni,ln],_=y):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o)):(d=_,_=o),_!==i&&(ve=u,_=Ce(_)),u=_,re[ec]={nextPos:d,result:u},u)}function zh(){var u,_,y,C,U,V=d*49+38,Q=re[V];return Q?(d=Q.nextPos,Q.result):(u=d,_=Kl(),_!==i?(n.charCodeAt(d)===84?(y=$e,d++):(y=i,ie===0&&he(vt)),y!==i?(C=Bh(),C!==i?(n.charCodeAt(d)===90?(U=ut,d++):(U=i,ie===0&&he(Sn)),U!==i?(ve=u,_=fn(_,C),u=_):(d=u,u=o)):(d=u,u=o)):(d=u,u=o)):(d=u,u=o),u===i&&(u=d,_=Kl(),_!==i?(n.charCodeAt(d)===84?(y=$e,d++):(y=i,ie===0&&he(vt)),y!==i?(C=kh(),C!==i?(ve=u,_=lr(_,C),u=_):(d=u,u=o)):(d=u,u=o)):(d=u,u=o)),re[V]={nextPos:d,result:u},u)}function Re(){var u,_=d*49+39,y=re[_];return y?(d=y.nextPos,y.result):(zn.test(n.charAt(d))?(u=n.charAt(d),d++):(u=i,ie===0&&he(ws)),re[_]={nextPos:d,result:u},u)}function pn(){var u,_,y,C=d*49+40,U=re[C];return U?(d=U.nextPos,U.result):(n.charCodeAt(d)===10?(u=Rs,d++):(u=i,ie===0&&he(Cs)),u===i&&(u=d,n.charCodeAt(d)===13?(_=zi,d++):(_=i,ie===0&&he(cr)),_!==i?(n.charCodeAt(d)===10?(y=Rs,d++):(y=i,ie===0&&he(Cs)),y!==i?(_=[_,y],u=_):(d=u,u=o)):(d=u,u=o)),re[C]={nextPos:d,result:u},u)}function jl(){var u,_=d*49+41,y=re[_];return y?(d=y.nextPos,y.result):(u=pn(),u===i&&(u=Re()),re[_]={nextPos:d,result:u},u)}function gr(){var u,_,y=d*49+42,C=re[y];return C?(d=C.nextPos,C.result):(u=d,ie++,n.length>d?(_=n.charAt(d),d++):(_=i,ie===0&&he(g)),ie--,_===i?u=p:(d=u,u=o),re[y]={nextPos:d,result:u},u)}function mn(){var u,_=d*49+43,y=re[_];return y?(d=y.nextPos,y.result):(Hi.test(n.charAt(d))?(u=n.charAt(d),d++):(u=i,ie===0&&he(ur)),re[_]={nextPos:d,result:u},u)}function _t(){var u,_,y=d*49+44,C=re[y];return C?(d=C.nextPos,C.result):(hr.test(n.charAt(d))?(u=n.charAt(d),d++):(u=i,ie===0&&he(ma)),u===i&&(u=d,n.charCodeAt(d)===95?(_=ga,d++):(_=i,ie===0&&he(_a)),_!==i&&(ve=u,_=xa()),u=_),re[y]={nextPos:d,result:u},u)}function Zl(){var u,_=d*49+45,y=re[_];return y?(d=y.nextPos,y.result):(va.test(n.charAt(d))?(u=n.charAt(d),d++):(u=i,ie===0&&he(Ma)),re[_]={nextPos:d,result:u},u)}function Ls(){var u,_,y,C=d*49+46,U=re[C];if(U)return d=U.nextPos,U.result;if(u=d,_=[],y=_t(),y!==i)for(;y!==i;)_.push(y),y=_t();else _=o;return _!==i&&(ve=u,_=T(_)),u=_,re[C]={nextPos:d,result:u},u}function Jl(){var u,_,y=d*49+47,C=re[y];return C?(d=C.nextPos,C.result):(u=d,n.substr(d,2)===z?(_=z,d+=2):(_=i,ie===0&&he($)),_!==i&&(ve=u,_=q()),u=_,u===i&&(u=d,n.substr(d,2)===H?(_=H,d+=2):(_=i,ie===0&&he(le)),_!==i&&(ve=u,_=Se()),u=_,u===i&&(u=d,n.substr(d,2)===we?(_=we,d+=2):(_=i,ie===0&&he(be)),_!==i&&(ve=u,_=He()),u=_,u===i&&(u=d,n.substr(d,2)===We?(_=We,d+=2):(_=i,ie===0&&he(Oe)),_!==i&&(ve=u,_=nt()),u=_,u===i&&(u=d,n.substr(d,2)===ft?(_=ft,d+=2):(_=i,ie===0&&he(Ct)),_!==i&&(ve=u,_=bt()),u=_,u===i&&(u=d,n.substr(d,2)===gt?(_=gt,d+=2):(_=i,ie===0&&he(Be)),_!==i&&(ve=u,_=wt()),u=_,u===i&&(u=d,n.substr(d,2)===ot?(_=ot,d+=2):(_=i,ie===0&&he(Kt)),_!==i&&(ve=u,_=ti()),u=_,u===i&&(u=Hh()))))))),re[y]={nextPos:d,result:u},u)}function Hh(){var u,_,y,C,U,V,Q,Ee,Xe,Mt,ht,Lt=d*49+48,It=re[Lt];return It?(d=It.nextPos,It.result):(u=d,n.substr(d,2)===Xt?(_=Xt,d+=2):(_=i,ie===0&&he(_i)),_!==i?(y=d,C=mn(),C!==i?(U=mn(),U!==i?(V=mn(),V!==i?(Q=mn(),Q!==i?(Ee=mn(),Ee!==i?(Xe=mn(),Xe!==i?(Mt=mn(),Mt!==i?(ht=mn(),ht!==i?(C=[C,U,V,Q,Ee,Xe,Mt,ht],y=C):(d=y,y=o)):(d=y,y=o)):(d=y,y=o)):(d=y,y=o)):(d=y,y=o)):(d=y,y=o)):(d=y,y=o)):(d=y,y=o),y!==i?(ve=u,_=At(y),u=_):(d=u,u=o)):(d=u,u=o),u===i&&(u=d,n.substr(d,2)===jt?(_=jt,d+=2):(_=i,ie===0&&he(rn)),_!==i?(y=d,C=mn(),C!==i?(U=mn(),U!==i?(V=mn(),V!==i?(Q=mn(),Q!==i?(C=[C,U,V,Q],y=C):(d=y,y=o)):(d=y,y=o)):(d=y,y=o)):(d=y,y=o),y!==i?(ve=u,_=At(y),u=_):(d=u,u=o)):(d=u,u=o)),re[Lt]={nextPos:d,result:u},u)}var Ql=[];function Vh(u,_,y){var C=new Error(u);throw C.line=_,C.column=y,C}function ba(u){Ql.push(u)}function Gt(u,_,y,C,U){var V={type:u,value:_,line:y(),column:C()};return U&&(V.key=U),V}function Gh(u,_,y){var C=parseInt("0x"+u);if(!isFinite(C)||Math.floor(C)!=C||C<0||C>1114111||C>55295&&C<57344)Vh("Invalid Unicode escape code: "+u,_,y);else return Wh(C)}function Wh(){var u=16384,_=[],y,C,U=-1,V=arguments.length;if(!V)return"";for(var Q="";++U<V;){var Ee=Number(arguments[U]);Ee<=65535?_.push(Ee):(Ee-=65536,y=(Ee>>10)+55296,C=Ee%1024+56320,_.push(y,C)),(U+1==V||_.length>u)&&(Q+=String.fromCharCode.apply(null,_),_.length=0)}return Q}if(dr=l(),dr!==i&&d===n.length)return dr;throw dr!==i&&d<n.length&&he({type:"end",description:"end of input"}),Th(null,ya,fr)}return{SyntaxError:e,parse:t}}()),po}var mo,Cu;function Bx(){if(Cu)return mo;Cu=1;function r(e){var t=[],n=[],s="",i=Object.create(null),a=i;return l(e);function l(R){for(var b,E=0;E<R.length;E++)switch(b=R[E],b.type){case"Assign":o(b);break;case"ObjectPath":g(b);break;case"ArrayPath":v(b);break}return i}function c(R,b,E){var I=new Error(R);throw I.line=b,I.column=E,I}function o(R){var b=R.key,E=R.value,I=R.line,D=R.column,N;s?N=s+"."+b:N=b,typeof a[b]<"u"&&c("Cannot redefine existing key '"+N+"'.",I,D),a[b]=f(E),h(N)||(t.push(N),n.push(N))}function h(R){return t.indexOf(R)!==-1}function f(R){return R.type==="Array"?x(R.value):R.type==="InlineTable"?p(R.value):R.value}function p(R){for(var b=Object.create(null),E=0;E<R.length;E++){var I=R[E];I.value.type==="InlineTable"?b[I.key]=p(I.value.value):I.type==="InlineTableValue"&&(b[I.key]=f(I.value))}return b}function g(R){var b=R.value,E=b.map(m).join("."),I=R.line,D=R.column;h(E)&&c("Cannot redefine existing key '"+b+"'.",I,D),t.push(E),a=M(i,b,Object.create(null),I,D),s=b}function v(R){var b=R.value,E=b.map(m).join("."),I=R.line,D=R.column;if(h(E)||t.push(E),t=t.filter(function(k){return k.indexOf(E)!==0}),t.push(E),a=M(i,b,[],I,D),s=E,a instanceof Array){var N=Object.create(null);a.push(N),a=N}else c("Cannot redefine existing key '"+b+"'.",I,D)}function M(R,b,E,I,D){var N=[],k="";b.join(".");for(var A=R,w=0;w<b.length;w++){var L=b[w];N.push(L),k=N.join("."),typeof A[L]>"u"?w===b.length-1?A[L]=E:A[L]=Object.create(null):w!==b.length-1&&n.indexOf(k)>-1&&c("Cannot redefine existing key '"+k+"'.",I,D),A=A[L],A instanceof Array&&A.length&&w<b.length-1&&(A=A[A.length-1])}return A}function x(R){for(var b=null,E=0;E<R.length;E++){var I=R[E];b===null?b=I.type:I.type!==b&&c("Cannot add value of type "+I.type+" to array of type "+b+".",I.line,I.column)}return R.map(f)}function m(R){return R.indexOf(".")>-1?'"'+R+'"':R}}return mo={compile:r},mo}var go,Pu;function kx(){if(Pu)return go;Pu=1;var r=Ox(),e=Bx();return go={parse:function(t){var n=r.parse(t.toString());return e.compile(n)}},go}var zx=kx();const Hx=Fx(zx);async function Vx(r){const t=await(await fetch(r)).text();return Hx.parse(t)}const mi=await Vx("sceneConfig.toml"),jn=mi.planets,Yr=mi.moons,Pi=Math.pow(10,11);class _o{constructor({name:e,radius:t=null,diameter:n=null,distanceFromOrbitCenter:s,texturePath:i,normalMapPath:a=null,specularMapPath:l=null,emissiveMapPath:c=null,otherMaterialProps:o={},numberOfSegments:h=64,orbitRotationSpeed:f=1e-5,selfRotationSpeed:p=.1,orbitalPeriod:g=1,positionalAudio:v=null}){t?this.radius=t:n&&(this.radius=Math.pow(10,6)*n/2),this.name=e,this.distanceFromOrbitCenter=Math.pow(10,6)*s,this.positionalAudio=v;const M=new ca;if(this.texture=M.load(i),this.normalMap=a?M.load(a):null,this.specularMap=l?M.load(l):null,this.emissiveMap=c?M.load(c):null,o&&Object.keys(o).forEach(x=>{typeof o[x]=="string"&&o[x].startsWith("#")&&(o[x]=new Ve(o[x]))}),this.material=new Ud({map:this.texture,normalMap:this.normalMap,specularMap:this.specularMap,emissiveMap:this.emissiveMap,...o}),this.material.transparent=!1,this.material.opacity=1,this.material.side=Ln,this.numberOfSegments=h,this.geometry=new Al(this.radius,h,h),this.mesh=new en(this.geometry,this.material),this.mesh.position.set(0,0,this.distanceFromOrbitCenter),this.orbit=new xt,this.orbit.add(this.mesh),this.orbitalPeriod=g,this.orbitRotationSpeed=Math.PI*2/(g*365*24*60*60),this.selfRotationSpeed=p,this.name==="Saturn"){const x=66.9*Math.pow(10,6),m=270*Math.pow(10,6);this.ringGeometry=new bl(x,m,128,1,0,Math.PI*2);{const R=this.ringGeometry.attributes.position,b=new Float32Array(R.count*2);for(let E=0;E<R.count;E++){const I=R.getX(E),D=R.getY(E),N=Math.sqrt(I*I+D*D),k=(Math.atan2(D,I)+Math.PI)/(2*Math.PI),A=(N-x)/(m-x),w=k;b[E*2+0]=A,b[E*2+1]=w}this.ringGeometry.setAttribute("uv",new Yt(b,2))}this.ringTexture=new ca().load("saturn/saturn-ring-texture.png",()=>{this.ringTexture.wrapS=Zn,this.ringTexture.wrapT=Fi,this.ringTexture.repeat.set(1,1)}),this.ringMaterial=new fi({map:this.ringTexture,transparent:!0,depthWrite:!0,depthTest:!0,side:wn}),this.ringMesh=new en(this.ringGeometry,this.ringMaterial),this.ringMesh.position.set(0,0,this.distanceFromOrbitCenter),this.ringMesh.rotation.x=-Math.PI*.6,this.orbit.add(this.ringMesh),this.mesh.renderOrder=0,this.ringMesh.renderOrder=1}}loadPositionalAudio(e){console.log(`Loading positional audio for ${this.name}`),console.log(e),console.log(this.positionalAudio);const t=new cp(e),n=new np,s=this.positionalAudio.refDistance*Math.pow(10,6);n.load(this.positionalAudio.filePath,function(i){t.setBuffer(i),t.setRefDistance(s),t.play()}),this.mesh.add(t)}}class Gx{constructor({scale:e=.01,maxSpeed:t=299792458,currentSpeed:n=0,spaceShipMeshPath:s="space-ship/scene.gltf",acceleration:i=1,maxAcceleration:a=1e7,baseAccelerationIncrease:l=1e6,breakStrength:c=.5,rotationSpeed:o=.5,spaceshipStartingPosition:h=new O(-jn[mi.spaceShipStartingPosition].diameter*Math.pow(10,6),0,jn[mi.spaceShipStartingPosition].distanceFromOrbitCenter*Math.pow(10,6)+jn[mi.spaceShipStartingPosition].diameter*Math.pow(10,6)),fov:f=75,near:p=.001,far:g=Math.pow(10,15),aspect:v=2,maxBank:M=.35,maxPitch:x=.35,tiltSpring:m=5}={}){this.status="loading",this.maxSpeed=t,this.rotationSpeed=o,this.currentSpeed=n,this.acceleration=i,this.maxAcceleration=a,this.baseAccelerationIncrease=l,this.breakStrength=c,this.spaceshipStartingPosition=h,this.pivot=new xt,this.centeredMesh=new xt;const R=new tx;this.ready=new Promise(b=>{this._resolveReady=b}),R.load(s,b=>{this.mesh=b.scene,this.mesh.traverse(N=>{if(!N.isMesh)return;(Array.isArray(N.material)?N.material:[N.material]).forEach(A=>{A&&(A.transparent&&(A.transparent=!1,A.alphaTest=.02),A.depthTest=!0,A.depthWrite=!0,A.side=Ln)})}),this.mesh.scale.set(e,e,e),this.mesh.position.set(0,0,0),this.mesh.rotation.set(.2,0,-.3),this.centeredMesh.add(this.mesh),this.pivot.add(this.centeredMesh),this.mesh.updateWorldMatrix(!0,!0);const I=new On().setFromObject(this.mesh).getCenter(new O);this.mesh.position.sub(I),this.pivot.position.set(h.x,h.y,h.z),this.pivot.lookAt(0,0,0),this.camera=new Qt(f,v,p,g),this.camera.position.set(.3,1,-5),this.camera.position.multiplyScalar(e*2),this.camera.lookAt(0,0,0),this.pivot.add(this.camera);const D=new ap;this.cameraListener=D,this.camera.add(D),this.maxBank=M,this.maxPitch=x,this.tiltSpring=m,this.status="ready",this.mesh.emissive=new Ve("#d81212"),this.mesh.emissiveIntensity=1,this._resolveReady?.()})}addAxes(e=!0,t=!0){if(e){const n=new jc(2);n.material.depthTest=!1,n.renderOrder=1,this.mesh.add(n)}if(t){const n=new jc(2);n.material.depthTest=!1,n.renderOrder=1,this.pivot.add(n)}}lookAt(e){this.pivot.lookAt(e)}moveTo(e){const t=new O(-jn[e].diameter*Math.pow(10,6),0,jn[e].distanceFromOrbitCenter*Math.pow(10,6)+jn[e].diameter*Math.pow(10,6));this.pivot.position.set(t.x,t.y,t.z),this.pivot.lookAt(0,0,0)}}const ui={},Ws={},tt=new Gx;let Lu=0,Kr=null;const Xs=new O,Iu=new O,Du=new O,Uu=new O,Nu=new O,Wx=mi.colors[mi.spaceBackground],Bt=new Set;window.addEventListener("keydown",r=>{["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(r.key)&&r.preventDefault(),Bt.add(r.code)});window.addEventListener("keyup",r=>Bt.delete(r.code));const Fu=document.getElementById("solar-body");Fu.addEventListener("change",()=>{tt.moveTo(Fu.value)});function Xx(r){const e=r.domElement,t=e.clientWidth,n=e.clientHeight,s=e.width!==t||e.height!==n;return s&&r.setSize(t,n,!1),s}function $x(){const r=document.querySelector("#c"),e=document.getElementById("hud-speed"),t=document.getElementById("hud-dist"),n=document.getElementById("hud-dist-mars"),s=document.getElementById("hud-dist-mercury"),i=document.getElementById("hud-dist-earth-moon"),a=new Su({logarithmicDepthBuffer:!0,antialias:!0,canvas:r}),l=new Ed;l.background=new Ve(Wx);const c=new ca;let o;if(mi.addStars){const L=[];for(let ne=0;ne<1e3;ne++)L.push(na.randFloatSpread(Math.pow(10,15),Math.pow(10,16)),na.randFloatSpread(Math.pow(10,15),Math.pow(10,16)),na.randFloatSpread(Math.pow(10,15),Math.pow(10,16)));const Y=c.load("white-circle.png"),X=new sn;X.setAttribute("position",new zt(L,3));const G=new Tl({map:Y,size:.5});o=new uh(X,G),l.add(o)}const h=new xt;l.add(h),h.add(tt.pivot);const f=new _o(jn.sun);h.add(f.mesh);const p=new ph(16777215,5,Math.pow(10,25),0);p.position.set(0,0,0),l.add(p),Object.keys(jn).forEach(L=>{const Y=new _o(jn[L]);Y.positionalAudio&&(async()=>(await tt.ready,Y.loadPositionalAudio(tt.cameraListener)))(),h.add(Y.orbit),ui[L]=Y}),Object.keys(Yr).forEach(L=>{const Y=new _o(Yr[L]);Y.orbit.position.set(0,0,ui[Yr[L].parentPlanet].distanceFromOrbitCenter),ui[Yr[L].parentPlanet].orbit.add(Y.orbit),Ws[L]=Y});const g={},v={};let M=null;const x=c.load("white-circle.png"),m=Pi*.04;function R(L=16777215){const Y=new rh({map:x,color:L,depthTest:!1,depthWrite:!1,transparent:!0,opacity:.95}),X=new Td(Y);return X.layers.set(1),X.scale.setScalar(m),l.add(X),X}const b=new O;Object.entries(ui).forEach(([L,Y])=>{const G=R(L==="sun"?16763904:L==="earth"?5614335:L==="mars"?16737860:16777215);Y.mesh.getWorldPosition(b),G.position.copy(b),g[L]=G}),Object.entries(Ws).forEach(([L,Y])=>{const X=R(11184810);Y.mesh.getWorldPosition(b),X.position.copy(b),v[L]=X}),M=R(65416),tt.pivot.getWorldPosition(b),M.position.copy(b);const E=new da(-Pi,Pi,Pi,-Pi,1,1e15);E.up.set(0,0,-1),E.lookAt(new O(0,-1,0)),E.layers.set(1);const I=new Su({canvas:document.getElementById("minimap"),alpha:!0,logarithmicDepthBuffer:!0});I.setSize(200,200),I.setPixelRatio(window.devicePixelRatio);const D=8;function N(){const L=I.getDrawingBufferSize(new Ke),Y=2*Pi/L.y,X=D*Y;Object.values(g).forEach(G=>G.scale.setScalar(X)),Object.values(v).forEach(G=>G.scale.setScalar(X)),M&&M.scale.setScalar(X)}let k=tt.centeredMesh,A=new yn;A.copy(tt.centeredMesh.rotation);function w(L){if(tt.status!=="ready")return requestAnimationFrame(w);L*=.001;const Y=Math.min(.05,L-Lu);if(Lu=L,Xx(a)&&(tt.camera.aspect=r.clientWidth/r.clientHeight,tt.camera.updateProjectionMatrix()),o.rotation.x=L*2e-4,o.rotation.y=L*2e-4,Object.values(ui).forEach(G=>{G.orbit.rotation.y=L*G.orbitRotationSpeed,G.mesh&&(G.mesh.rotation.y=L*G.selfRotationSpeed)}),Object.values(Ws).forEach(G=>{G.orbit.rotation.y=L*G.orbitRotationSpeed,G.mesh&&(G.mesh.rotation.y=L*G.selfRotationSpeed)}),f.mesh&&(f.mesh.rotation.y=L*.1),tt.pivot){const G=tt.pivot.getWorldDirection(new O).normalize(),ne=new O(0,1,0),K=new O;K.add(G),(Bt.has("KeyW")||Bt.has("ArrowUp"))&&tt.currentSpeed<tt.maxSpeed&&(tt.acceleration=Math.min(tt.acceleration+tt.baseAccelerationIncrease*Y,tt.maxAcceleration),tt.currentSpeed+=tt.acceleration*Y),(Bt.has("KeyS")||Bt.has("ArrowDown"))&&(tt.acceleration=0,tt.currentSpeed>0&&(tt.currentSpeed*=1-tt.breakStrength*Y)),Bt.has("KeyR")&&K.add(ne),Bt.has("KeyF")&&K.addScaledVector(ne,-1),K.lengthSq()>0&&(K.normalize().multiplyScalar(tt.currentSpeed*Y),tt.pivot.position.add(K));const oe=(Bt.has("ArrowLeft")|Bt.has("KeyA")?1:0)-(Bt.has("ArrowRight")|Bt.has("KeyD")?1:0);oe&&tt.pivot.rotateOnWorldAxis(ne,oe*tt.rotationSpeed*Y)}if(k){l.updateMatrixWorld(!0),Kr||(Kr=tt.pivot.position.clone());const G=tt.pivot.position,ne=G.distanceTo(Kr);Y>0&&(tt.speedUnitsPerSec=ne/(Y*1e3)),Kr.copy(G),k.getWorldPosition(Xs),f.mesh.getWorldPosition(Iu),ui.mars.mesh.getWorldPosition(Du),ui.mercury.mesh.getWorldPosition(Uu),Ws.earthMoon.mesh.getWorldPosition(Nu);const K=Xs.distanceTo(Iu)/Math.pow(10,6),oe=Xs.distanceTo(Du)/Math.pow(10,6),j=Xs.distanceTo(Uu)/Math.pow(10,6),me=Xs.distanceTo(Nu)/Math.pow(10,6);e&&(e.textContent=tt.speedUnitsPerSec.toFixed(2)),t&&(t.textContent=K.toFixed(0)),n&&(n.textContent=oe.toFixed(0)),s&&(s.textContent=j.toFixed(0)),i&&(i.textContent=me.toFixed(0));const _e=Bt.has("KeyR"),Ie=Bt.has("KeyF"),qe=Bt.has("ArrowLeft")|Bt.has("KeyA"),pt=Bt.has("ArrowRight")|Bt.has("KeyD"),ct=(Number(pt)-Number(qe))*tt.maxBank,J=(Number(Ie)-Number(_e))*tt.maxPitch,ge=Math.min(1,tt.tiltSpring*Y);k.rotation.x+=(A.x+J-k.rotation.x)*ge,k.rotation.z+=(A.z+ct-k.rotation.z)*ge,k.rotation.y=A.y}a.render(l,tt.camera);const X=new O;for(const[G,ne]of Object.entries(ui)){const K=g[G];K&&(ne.mesh.getWorldPosition(X),K.position.copy(X))}for(const[G,ne]of Object.entries(Ws)){const K=v[G];K&&(ne.mesh.getWorldPosition(X),K.position.copy(X))}M&&(tt.pivot.getWorldPosition(X),M.position.copy(X)),tt.pivot&&(tt.pivot.getWorldPosition(M.position),E.position.set(M.position.x,M.position.y+Pi,M.position.z),E.lookAt(M.position)),N(),I.render(l,E),requestAnimationFrame(w)}requestAnimationFrame(w)}$x();
